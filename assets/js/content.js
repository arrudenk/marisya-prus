 ...
 *
 *   Секції split і gallery — це «проєкти»: на головній вони показуються
 *   квадратними плитками, а вміст відкривається в оверлеї (#p/<slug>).
 *   Обкладинка плитки — перше зображення секції; щоб узяти інше, додай
 *   секції поле cover: 'assets/img/….jpg' (або Drive-лінк).
 *
